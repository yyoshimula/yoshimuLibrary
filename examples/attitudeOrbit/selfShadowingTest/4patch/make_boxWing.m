...
face = f4cube(face, 1, body_split, MLI);
...
face = f4cube(face, 2, sap_split, SAP);
% vert = rotation(vert, 0, 10, 0, 2, 6); % SAP rotation
vert = translation(vert, 0.0, 0.25+ sap_length(2)/2.0, 0.0, 2, 6);
...
face = f4cube(face, 3, sap_split, SAP);
% vert = rotation(vert, 0, 10, 0, 3, 6);
vert = translation(vert, 0.0, -0.25-sap_length(2)/2.0, 0.0, 3, 6);
